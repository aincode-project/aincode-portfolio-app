...
<head>
  ...
  <title>Login &mdash; Aincode</title>
...
<body>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="{{ asset('backend/assets/img/aincrad_logo.png') }}" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
  ...
  <!-- Toastr -->
  <script>
    // Ambil nilai toastr dari flash session
    var toastrMessage = '{{ session("toastr") }}';

    // Periksa apakah ada pesan toastr
    if (toastrMessage) {
        // Tampilkan toastr
        toastr.success(toastrMessage);

        // Hapus flash session data
