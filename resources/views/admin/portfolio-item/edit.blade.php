...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          <div class="breadcrumb-item active"><a href="{{ route('admin.portfolio-item.index') }}">Portfolio Item</a></div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.portfolio-item.update', $portfolio_item->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <textarea name="description" class="summernote">{!! $portfolio_item->title !!}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="text" name="link" class="form-control" value="{{ $portfolio_item->link }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="date" name="date" class="form-control" value="{{ $portfolio_item->date }}">
                        </div>
                    </div>

                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Portfolio Category</label>
                        <div class="col-sm-12 col-md-7">
                          <select name="portfolio_category_id" class="form-control selectric">
                            @foreach ($portfolio_categories as $portfolio_category)
                                <option value="{{ $portfolio_category->id }}" {{ $portfolio_item->portfolio_category_id == $portfolio_category->id ? 'selected' : '' }}>{{ $portfolio_category->name }}</option>
                            @endforeach
                          </select>
                        </div>
                    </div>
