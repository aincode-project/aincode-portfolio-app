        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="section-title">
                            <h3 class="title">{{ $skillTitle->title }}</h3>
                            <div class="desc">
                                <p>{{ $skillTitle->sub_title }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row skills">
                    ...
                    <div class="col-sm-6">
                        <div class="bar_group wow fadeInUp" data-wow-delay="0.3s" data-max="100">
                            ...
                            <div class="bar_group__bar thick elastic" data-value="{{ $skillItem->percent }}" data-color="{{ getColor($loop->index) }}"
            ...
            <div class="col-lg-6 d-none d-lg-block">
                <figure class="single-image text-right wow fadeInRight">
                    <img src="{{ asset($skillTitle->image) }}" alt="">
                </figure>
            </div>
        </div>
    </div>
